...
const slider = () => {
  const worksSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.works__slider', {
  ...
  const servicesSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.services__slider', {
    direction: 'horizontal',
    loop: true,
    speed: 500,
    navigation: {
